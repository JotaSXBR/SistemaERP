...
- se o recorte mudou o estado do projeto, atualiza `docs/development/ai-handoff.md` no mesmo PR;
...
Se o índice `.gitnexus/` existir, consulte `docs/development/gitnexus.md` para as regras de
análise de impacto e mudanças no grafo (obrigatórias para código de produção; isentas para
docs/config trivial, alinhado à validação proporcional).
